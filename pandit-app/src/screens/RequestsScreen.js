...
const s = StyleSheet.create({ screen: { flex: 1, backgroundColor: colors.bg }, list: { paddingHorizontal: 17, paddingBottom: 30, flexGrow: 1 }, header: { paddingTop: 7, paddingBottom: 7 }, headerRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, eyebrow: { color: colors.primary, fontSize: 10, fontWeight: "800", letterSpacing: 1.4 }, heading: { color: colors.ink, fontSize: 27, fontWeight: "800", marginTop: 5 }, subtitle: { color: colors.muted, fontSize: 9, lineHeight: 15, marginTop: 5 }, count: { minWidth: 49, height: 49, borderRadius: 14, backgroundColor: colors.primarySoft, alignItems: "center", justifyContent: "center" }, countValue: { color: colors.primary, fontSize: 17, fontWeight: "800" }, countLabel: { color: colors.primary, fontSize: 9, fontWeight: "800" }, card: { backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, padding: 14, marginTop: 11, overflow: "hidden", ...shadow }, newBadge: { position: "absolute", top: 0, left: 0, backgroundColor: colors.goldSoft, borderBottomRightRadius: 10, paddingHorizontal: 9, paddingVertical: 5 }, newText: { color: colors.gold, fontSize: 9, fontWeight: "800", letterSpacing: 0.7 }, cardTop: { flexDirection: "row", alignItems: "center", marginTop: 5 }, omBox: { width: 44, height: 44, borderRadius: 12, backgroundColor: colors.primarySoft, alignItems: "center", justifyContent: "center" }, om: { color: colors.primary, fontSize: 21 }, titleCopy: { flex: 1, marginLeft: 10 }, cardTitle: { color: colors.ink, fontSize: 13, lineHeight: 18, fontWeight: "800" }, requestId: { color: colors.muted, fontSize: 10, marginTop: 3 }, payoutBox: { alignItems: "flex-end" }, payoutLabel: { color: colors.muted, fontSize: 9, fontWeight: "800" }, payout: { color: colors.green, fontSize: 16, fontWeight: "800", marginTop: 3 }, metrics: { minHeight: 55, borderRadius: 11, backgroundColor: "#F5F1ED", flexDirection: "row", alignItems: "center", justifyContent: "space-around", marginTop: 13 }, metric: { alignItems: "center", flex: 1 }, metricLabel: { color: colors.muted, fontSize: 9, fontWeight: "800", letterSpacing: 0.6 }, metricValue: { color: "#504842", fontSize: 9, fontWeight: "800", marginTop: 4 }, rule: { width: 1, height: 27, backgroundColor: "#DDD4CC" }, location: { flexDirection: "row", alignItems: "center", marginTop: 12 }, locationMark: { width: 31, height: 31, borderRadius: 9, backgroundColor: "#EEE7E1", alignItems: "center", justifyContent: "center" }, locationMarkText: { color: colors.primary, fontSize: 16 }, locationCopy: { flex: 1, marginLeft: 9 }, locationLabel: { color: colors.muted, fontSize: 9, fontWeight: "800" }, locationValue: { color: "#504842", fontSize: 9, fontWeight: "700", marginTop: 2 }, locked: { color: colors.muted, fontSize: 9, marginTop: 2 }, materials: { borderTopWidth: 1, borderTopColor: "#EEE7E1", marginTop: 12, paddingTop: 11 }, materialsTitle: { color: colors.muted, fontSize: 10, fontWeight: "800", letterSpacing: 0.7 }, chips: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 7 }, chip: { backgroundColor: "#F1ECE7", borderRadius: 8, paddingHorizontal: 7, paddingVertical: 5 }, chipText: { color: "#6B615A", fontSize: 10, fontWeight: "700" }, noMaterials: { color: colors.muted, fontSize: 10, marginTop: 7 }, actions: { flexDirection: "row", gap: 8, marginTop: 14 }, decline: { flex: 0.8, height: 42, borderRadius: 11, borderWidth: 1, borderColor: "#DCCFC5", alignItems: "center", justifyContent: "center" }, declineText: { color: "#675D55", fontSize: 9, fontWeight: "800" }, accept: { flex: 1.2, height: 42, borderRadius: 11, backgroundColor: colors.green, flexDirection: "row", alignItems: "center", justifyContent: "center" }, acceptText: { color: "#FFFFFF", fontSize: 9, fontWeight: "800" }, arrow: { color: "#FFFFFF", fontSize: 20, marginLeft: 7, marginTop: -2 }, state: { alignItems: "center", paddingTop: 100 }, emptyIcon: { width: 55, height: 55, borderRadius: 28, backgroundColor: colors.greenSoft, alignItems: "center", justifyContent: "center" }, emptyIconText: { color: colors.green, fontSize: 20, fontWeight: "800" }, emptyTitle: { color: colors.ink, fontSize: 14, fontWeight: "800", marginTop: 13 }, stateText: { color: colors.muted, fontSize: 9, textAlign: "center", marginTop: 6 }, retry: { color: colors.primary, fontSize: 10, fontWeight: "800", marginTop: 13 }, pending: { flex: 1, alignItems: "center", justifyContent: "center", padding: 28 }, pendingIcon: { width: 76, height: 76, borderRadius: 38, backgroundColor: colors.goldSoft, alignItems: "center", justifyContent: "center" }, pendingMark: { color: colors.gold, fontSize: 25, fontWeight: "800" }, pendingTitle: { color: colors.ink, fontSize: 23, fontWeight: "800", marginTop: 8 }, pendingText: { color: colors.muted, fontSize: 10, lineHeight: 17, textAlign: "center", marginTop: 8 }, pendingStatus: { flexDirection: "row", alignItems: "center", backgroundColor: colors.goldSoft, borderRadius: 10, paddingHorizontal: 11, paddingVertical: 7, marginTop: 18 }, liveDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.gold, marginRight: 6 }, pendingStatusText: { color: colors.gold, fontSize: 10, fontWeight: "800" }, primaryButton: { width: "100%", height: 48, borderRadius: 12, backgroundColor: colors.primary, alignItems: "center", justifyContent: "center", marginTop: 25 }, primaryText: { color: "#FFFFFF", fontSize: 10, fontWeight: "800" } });
