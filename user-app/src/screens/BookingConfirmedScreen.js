  ...
  return (
    <SafeAreaView style={s.screen}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.content}>
        ...
        {booking?.service_otp ? <View style={s.otpCard}><Text style={s.otpLabel}>{booking.service_otp.phase === "start" ? "START POOJA OTP" : "COMPLETE POOJA OTP"}</Text><Text style={s.otpCode}>{booking.service_otp.code}</Text><Text style={s.otpHint}>{hindi ? "यह OTP केवल अपने पंडित जी के साथ साझा करें। यह 5 मिनट तक मान्य है।" : "Share this OTP only with your pandit. It is valid for 5 minutes."}</Text></View> : null}
...
const s = StyleSheet.create({
  ...
  otpCard: { backgroundColor: "#FFF3D7", borderWidth: 1, borderColor: "#E6C77D", borderRadius: 17, padding: 17, marginTop: 18, alignItems: "center" }, otpLabel: { color: "#8B6417", fontSize: 9, fontWeight: "900", letterSpacing: 1.2 }, otpCode: { color: "#5B3E08", fontSize: 32, fontWeight: "900", letterSpacing: 8, marginTop: 8 }, otpHint: { color: "#80662E", fontSize: 10, lineHeight: 15, textAlign: "center", marginTop: 7 },
