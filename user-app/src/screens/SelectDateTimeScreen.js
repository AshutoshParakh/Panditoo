  ...
  return (
    <SafeAreaView style={s.screen}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.content}>
        ...
        <View style={s.poojaStrip}><View style={s.omBox}><Text style={s.om}>ॐ</Text></View><View style={s.poojaCopy}><Text style={s.poojaLabel}>{hindi ? "आप बुक कर रहे हैं" : "YOU’RE BOOKING"}</Text><Text numberOfLines={1} style={s.poojaName}>{pooja?.name || (hindi ? "पूजा" : "Pooja ceremony")}</Text></View><View style={s.stepBadge}><Text style={s.stepText}>1 / 3</Text></View></View>
...
const s = StyleSheet.create({
  screen: { flex: 1, backgroundColor: "#F8F5F0" }, content: { paddingHorizontal: 18 }, intro: { paddingTop: 9, paddingBottom: 18 }, eyebrow: { color: colors.primary, fontSize: 9, fontWeight: "800", letterSpacing: 1.4 }, title: { color: colors.ink, fontSize: 27, lineHeight: 34, fontWeight: "800", marginTop: 7 }, subtitle: { color: colors.muted, fontSize: 11, lineHeight: 17, marginTop: 5 },
  poojaStrip: { height: 67, borderRadius: 15, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#E7DDD4", paddingHorizontal: 12, flexDirection: "row", alignItems: "center", ...shadow }, omBox: { width: 41, height: 41, borderRadius: 11, backgroundColor: "#F1E7E1", alignItems: "center", justifyContent: "center" }, om: { color: colors.primary, fontSize: 20 }, poojaCopy: { flex: 1, marginLeft: 11 }, poojaLabel: { color: colors.muted, fontSize: 7, fontWeight: "800", letterSpacing: 0.9 }, poojaName: { color: colors.ink, fontSize: 12, fontWeight: "800", marginTop: 3 }, stepBadge: { backgroundColor: "#F1ECE7", borderRadius: 9, paddingHorizontal: 8, paddingVertical: 5 }, stepText: { color: "#776C64", fontSize: 8, fontWeight: "800" },
  sectionHeader: { flexDirection: "row", alignItems: "center", marginTop: 25, marginBottom: 10 }, sectionNumber: { width: 30, height: 30, borderRadius: 9, backgroundColor: "#ECE4DD", alignItems: "center", justifyContent: "center", marginRight: 10 }, sectionNumberText: { color: colors.primary, fontSize: 8, fontWeight: "800" }, sectionTitle: { color: colors.ink, fontSize: 14, fontWeight: "800" }, sectionHint: { color: colors.muted, fontSize: 8, marginTop: 2 },
